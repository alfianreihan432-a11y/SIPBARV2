...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIPBAR Siswa'); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <a href="<?php echo e(route('student.dashboard')); ?>" class="sidebar-brand">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('student.catalog')); ?>" class="nav-item <?php echo e(request()->routeIs('student.catalog') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('student.loans')); ?>" class="nav-item <?php echo e(request()->routeIs('student.loans') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('student.returns.index')); ?>" class="nav-item <?php echo e(request()->routeIs('student.returns.*') ? 'active' : ''); ?>">
                ...
                Pengembalian
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeBorrowedCount > 0): ?>
                <span class="nav-badge"><?php echo e($activeBorrowedCount); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </a>
            <a href="<?php echo e(route('student.history')); ?>" class="nav-item <?php echo e(request()->routeIs('student.history') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('student.announcements')); ?>" class="nav-item <?php echo e(request()->routeIs('student.announcements') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('student.profile')); ?>" class="nav-item <?php echo e(request()->routeIs('student.profile') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('student.catalog')); ?>" class="nav-cta">
            ...
            <div class="topbar-right">
                ...
                <div class="topbar-user-wrap">
                    ...
                    <div id="profileDropdown" class="profile-dropdown-menu">
                        ...
                        <a href="<?php echo e(route('student.profile')); ?>" class="pdm-link">
                        ...
                        <a href="<?php echo e(route('student.loans')); ?>" class="pdm-link">
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views/layouts/siswa.blade.php ENDPATH**/ ?>