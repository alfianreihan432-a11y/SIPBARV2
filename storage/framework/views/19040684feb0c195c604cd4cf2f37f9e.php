...
<?php $__env->startSection('page-heading', 'Peminjaman Saya'); ?>
...
<div>
    ...
    <div class="loans-grid">
        <div class="loans-card">
            <div>
                ...
                <div class="loans-card-value">
                    <?php echo e(\App\Models\BorrowingRequest::where('user_id', auth()->id())->where('status', 'pending')->count()); ?>
        ...
        <div class="loans-card">
            <div>
                ...
                <div class="loans-card-value">
                    <?php echo e(\App\Models\BorrowingRequest::where('user_id', auth()->id())->whereIn('status', ['approved', 'borrowed'])->count()); ?>
    ...
    <div class="loans-panel">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requests->count() > 0): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="loans-item">
                <div class="loans-item-top">
                    <div>
                        <div class="loans-item-name"><?php echo e($request->item?->name ?? 'Barang tidak tersedia'); ?></div>
                        <div class="loans-item-code">ID: #<?php echo e($request->id); ?></div>
                    </div>
                    <span class="loans-badge
                        <?php if($request->status === 'pending'): ?> loans-badge-pending
                        <?php elseif($request->status === 'approved' || $request->status === 'qr_ready'): ?> loans-badge-approved
                        <?php elseif($request->status === 'rejected'): ?> loans-badge-rejected
                        <?php elseif($request->status === 'borrowed'): ?> loans-badge-borrowed
                        <?php elseif($request->status === 'returned'): ?> loans-badge-returned
                        <?php else: ?> loans-badge-pending <?php endif; ?>">
                ...
                <div class="loans-item-meta">
                    ...
                    <div>Qty: <?php echo e($request->quantity); ?></div>
                    <div><?php echo e($request->borrow_date->format('d M Y')); ?> - <?php echo e($request->return_date->format('d M Y')); ?></div>
                </div>
            </div>
