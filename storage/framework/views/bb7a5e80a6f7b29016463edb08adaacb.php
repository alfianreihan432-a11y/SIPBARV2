<?php $__env->startSection('title', 'Riwayat Pengembalian – SIPBAR'); ?>
<?php $__env->startSection('page-heading', 'Riwayat Pengembalian'); ?>
...
<div>
    ...
    <div class="nav-tabs-bar">
        <a href="<?php echo e(route('student.returns.index')); ?>" class="nav-tab-btn">
        ...
        <a href="<?php echo e(route('student.returns.history')); ?>" class="nav-tab-btn active">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:15px;height:15px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="history-panel">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
            ...
            <a href="<?php echo e(route('student.returns.index')); ?>" class="btn-reapply" style="font-size: 12px; padding: 8px 14px;">
                            ...
                            <tr>
                                <td>
                                    <div style="font-weight: 800; color: var(--text);">
                                        <?php echo e($ret->borrowingRequest?->item?->name ?? 'Barang'); ?>

                                    </div>
                                    <div style="font-size: 11px; color: var(--muted); margin-top: 2px;">
                                        ID Peminjaman: #<?php echo e($ret->borrowing_request_id); ?> &bull; Qty: <?php echo e($ret->borrowingRequest?->quantity ?? 1); ?>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center; gap: 8px;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ret->foto_bukti): ?>
                                            <img src="<?php echo e(asset('storage/' . $ret->foto_bukti)); ?>" alt="Foto Bukti" class="photo-thumb" onclick="openPhotoModal('<?php echo e(asset('storage/' . $ret->foto_bukti)); ?>')">
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ret->catatan): ?>
                                                <div style="font-size: 11px; color: var(--muted); margin-top: 4px; max-width: 180px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;" title="<?php echo e($ret->catatan); ?>">
                                ...
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ret->status === 'disetujui'): ?>
                                        <div style="font-size: 11px; color: #065f46; font-weight: 600;">
                                            Diverifikasi oleh <?php echo e($ret->verifier?->name ?? 'Admin'); ?>

                                        </div>
                                        <div style="font-size: 10px; color: var(--muted);">
                                            <?php echo e($ret->tanggal_verifikasi ? $ret->tanggal_verifikasi->format('d M Y H:i') : ''); ?>

                                        </div>
                                    <?php elseif($ret->status === 'ditolak'): ?>
                                        <div style="color: #991b1b; font-size: 12px; font-weight: 600; margin-bottom: 4px;">
                                            Alasan: "<?php echo e($ret->alasan_ditolak); ?>"
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ret->borrowingRequest && $ret->borrowingRequest->status === 'borrowed'): ?>
                                            <a href="<?php echo e(route('student.returns.create', $ret->borrowing_request_id)); ?>" class="btn-reapply">
                                                Ajukan Ulang &rarr;
                                            </a>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\pages\siswa\returns\history.blade.php ENDPATH**/ ?>