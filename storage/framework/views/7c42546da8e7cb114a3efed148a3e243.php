...
<body>
    <div class="wrapper">
        ...
        <!-- Body -->
        <div class="body">
            <p class="greeting">Yth. <?php echo e($borrowingRequest->teacher?->name ?? 'Bapak/Ibu Guru'); ?>,</p>
            <p class="intro">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($borrowingRequest->user?->name ?? '-'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Kelas</span>
                    <span class="info-value"><?php echo e($borrowingRequest->user?->kelas ?? '-'); ?></span>
                </div>
                <div class="info-row">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($borrowingRequest->notes): ?>
                <div class="info-row">
                    <span class="info-label">Catatan</span>
                    <span class="info-value"><?php echo e($borrowingRequest->notes); ?></span>
                </div>
            ...
            <div class="purpose-box">
                <h3>📝 Keperluan</h3>
                <p><?php echo e($borrowingRequest->purpose); ?></p>
            </div>
            ...
            <div class="cta-section">
                ...
                <a href="<?php echo e($approvalUrl); ?>" class="btn-approve">
...
<?php /**PATH C:\Users\Dell\SIPBARV2\resources\views/emails/new-request.blade.php ENDPATH**/ ?>