...
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route($nav[1])); ?>" class="nav-item <?php echo e(request()->routeIs($nav[1]) || (str_starts_with($nav[1], 'student.returns') && request()->routeIs('student.returns.*')) ? 'active' : ''); ?>">
