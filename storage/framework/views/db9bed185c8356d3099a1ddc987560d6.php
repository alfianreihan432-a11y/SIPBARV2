...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route($nav[1])); ?>" class="nav-item <?php echo e(request()->routeIs($nav[1]) ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($nav[2]); ?>"/>
            </svg>
            <?php echo e($nav[0]); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nav[3]): ?>
            <span class="nav-badge"><?php echo e($nav[3]); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </a>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

        
        <a href="<?php echo e(route('student.catalog')); ?>" style="display:flex;align-items:center;gap:10px;padding:12px;margin-top:8px;background:#fff;border-radius:12px;text-decoration:none;box-shadow:0 2px 8px rgba(0,0,0,.08);transition:all .2s;">
...
<div class="main">
    ...
    <div class="topbar">
        ...
        <div class="topbar-right">
            ...
            <a href="<?php echo e(route('home')); ?>" class="topbar-icon" title="Kembali ke Beranda" style="text-decoration:none">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3965724839-0', $__key);
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\dashboard-siswa.blade.php ENDPATH**/ ?>