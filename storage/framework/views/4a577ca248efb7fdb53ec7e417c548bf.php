<?php
if (!function_exists('_4a577ca248efb7fdb53ec7e417c548bf')):
function _4a577ca248efb7fdb53ec7e417c548bf($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _afb80f9a481bc6f154b41a9a23b85b61($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php endif; ?>
<?php $__slotse622ccae69f25b78ece9d5e8f6bba7c0['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotse622ccae69f25b78ece9d5e8f6bba7c0); ?>
<?php _e622ccae69f25b78ece9d5e8f6bba7c0($__blaze, $__attrse622ccae69f25b78ece9d5e8f6bba7c0, $__slotse622ccae69f25b78ece9d5e8f6bba7c0, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\stubs\resources\views\flux\badge\index.blade.php ENDPATH**/ ?>