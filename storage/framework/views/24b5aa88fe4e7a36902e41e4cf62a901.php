...
<nav class="nav">
  ...
  <div id="navMob" class="nav-mobile">
    ...
    <div class="nav-mobile-actions">
      <a href="<?php echo e(route('login')); ?>" class="nav-mob-login">Masuk</a>
    </div>
  </div>
</nav>
</header>
...
<section class="section feat-bg" id="fitur">
  <div class="section-inner">
    ...
    <div class="feat-grid">
      ...
      ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $feats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
      <a href="<?php echo e(route($f[5] . '.index')); ?>" class="feat-card" style="text-decoration:none">
      <?php else: ?>
      <a href="<?php echo e(route('login')); ?>" class="feat-card" style="text-decoration:none">
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <div class="feat-icon-wrap" style="background:<?php echo e($f[3]); ?>">
          <svg xmlns="http://www.w3.org/2000/svg" style="width:24px;height:24px;color:<?php echo e($f[4]); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($f[2]); ?>"/></svg>
        </div>
        <div class="feat-name"><?php echo e($f[0]); ?></div>
        <div class="feat-desc"><?php echo e($f[1]); ?></div>
      </a>
  ...
  <div class="section-inner">
    <div class="about-grid">
      <div>
        ...
        <ul class="check-list">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Mudah digunakan oleh semua pengguna','Sistem aman dan data terjaga','Dukungan penuh untuk kebutuhan sekolah','Akses fleksibel kapan saja dan di mana saja']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <li>
            <div class="check-dot">
        ...
        <div class="about-img-wrap">
          ...
          <div class="about-building">
            <div class="about-building-body">
              ...
              <div class="about-win-grid"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i=0;$i<14;$i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><div class="about-win"></div><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?></div>
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\welcome.blade.php ENDPATH**/ ?>