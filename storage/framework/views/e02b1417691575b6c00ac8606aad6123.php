<?php
if (!function_exists('_e02b1417691575b6c00ac8606aad6123')):
function _e02b1417691575b6c00ac8606aad6123($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div class="<?php echo e($containerClasses); ?>">
    ...
    <?php if ($paginate): ?>
        ...
        <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/pagination.blade.php', $__blaze->compiledPath.'/9d2047497f6f178bf81d6126a115c2bb.php'); ?>
<?php $__blaze->pushData(['attributes' => $paginationAttributes]); ?>
<?php _9d2047497f6f178bf81d6126a115c2bb($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\stubs\resources\views\flux\table\index.blade.php ENDPATH**/ ?>