...
<div class="lm-card">
    ...
    <div class="lm-header">
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <span class="lm-count"><?php echo e($borrowings->count()); ?> transaksi</span>
        </div>
        <div class="lm-search">
    ...
    <div class="lm-filter-row">
        ...
        <?php $statuses = ['semua'=>'Semua','pending'=>'Menunggu','approved'=>'Disetujui','borrowed'=>'Dipinjam','returned'=>'Dikembalikan','overdue'=>'Terlambat']; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <button class="lm-filter-btn <?php echo e(($filterStatus??'semua')===$val?'act':''); ?>"
            wire:click="$set('filterStatus','<?php echo e($val); ?>')">
            <?php echo e($lbl); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($val !== 'semua'): ?>
            <span style="font-size:10px;opacity:.7">(<?php echo e($borrowings->where('status',$val)->count()); ?>)</span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </button>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($borrowings->isEmpty()): ?>
    <div class="lm-empty">
    ...
    <div style="overflow-x:auto">
        <table class="lmt" id="lmTable">
            ...
            <tbody>
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                ?>
                <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'b-'.e($b->id).''; ?>wire:key="b-<?php echo e($b->id); ?>">
                    <td><span class="lmt-num"><?php echo e($nomorPinjam); ?></span></td>
                    <td>
                        <div class="lmt-student">
                            <div class="lmt-avatar"><?php echo e(strtoupper(substr($b->user?->name??'?',0,2))); ?></div>
                            <div>
                                <div class="lmt-name"><?php echo e($b->user?->name ?? '—'); ?></div>
                                <div class="lmt-nis">NIS: <?php echo e($b->user?->nis ?? '—'); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="lmt-item"><?php echo e($b->item?->name ?? '—'); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($b->purpose): ?>
                        <div style="font-size:11px;color:var(--text-subtle);margin-top:2px"><?php echo e(Str::limit($b->purpose, 40)); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <td>
                        <span class="lmt-qty"><?php echo e($b->quantity ?? 1); ?></span>
                    </td>
                    <td>
                        <div class="lmt-date"><?php echo e($borrowedAt ? \Carbon\Carbon::parse($borrowedAt)->format('d M Y') : '—'); ?></div>
                    </td>
                    <td><div class="lmt-due <?php echo e($dueClass); ?>"><?php echo e($dueText); ?></div></td>
                    <td>
                        <span class="lm-badge <?php echo e($badgeMap[$b->status] ?? 'badge-pending'); ?>">
                            <span style="width:5px;height:5px;border-radius:50%;background:currentColor"></span>
                            <?php echo e($labelMap[$b->status] ?? ucfirst($b->status)); ?>

                        </span>
                    </td>
                    <td>
                        <div style="display:flex;gap:6px;flex-wrap:wrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($b->status === 'pending'): ?>
                            <button wire:click="approve(<?php echo e($b->id); ?>)" class="lm-act-btn btn-approve">
                            ...
                            <button wire:click="reject(<?php echo e($b->id); ?>)" class="lm-act-btn btn-reject">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($b->status === 'approved'): ?>
                            <button wire:click="markBorrowed(<?php echo e($b->id); ?>)" class="lm-act-btn btn-borrowed">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($b->status, ['borrowed','overdue'])): ?>
                            <button wire:click="markReturned(<?php echo e($b->id); ?>)" class="lm-act-btn btn-return">
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\livewire\loan-manager.blade.php ENDPATH**/ ?>