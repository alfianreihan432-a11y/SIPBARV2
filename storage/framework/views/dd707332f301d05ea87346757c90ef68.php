<?php $__env->startSection('title', 'Barang Saya & Pengembalian – SIPBAR'); ?>
<?php $__env->startSection('page-heading', 'Pengembalian Barang'); ?>
...
<div>
    ...
    <div class="return-header-card">
        ...
        <a href="<?php echo e(route('student.returns.history')); ?>" style="background: rgba(255,255,255,0.2); color:#fff; text-decoration:none; font-weight:700; font-size:12px; padding:8px 16px; border-radius:8px; display:inline-flex; align-items:center; gap:6px;">
    ...
    <div class="return-stats-grid">
        <div class="stat-box">
            <div>
                ...
                <div class="stat-box-num"><?php echo e($totalBorrowed); ?></div>
            </div>
        ...
        <div class="stat-box">
            <div>
                ...
                <div class="stat-box-num"><?php echo e($pendingReturns); ?></div>
            </div>
        ...
        <div class="stat-box">
            <div>
                ...
                <div class="stat-box-num"><?php echo e($completedReturns); ?></div>
            </div>
    ...
    <div class="nav-tabs-bar">
        <a href="<?php echo e(route('student.returns.index')); ?>" class="nav-tab-btn active">
        ...
        <a href="<?php echo e(route('student.returns.history')); ?>" class="nav-tab-btn">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:15px;height:15px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
    ...
    <div class="loans-panel">
                ...
                <div class="loan-card-item">
                    <div>
                        <div class="item-title-row">
                            <span class="item-name"><?php echo e($loan->item?->name ?? 'Barang #' . $loan->item_id); ?></span>
                            <span class="item-code-tag"><?php echo e($loan->item?->code ?? 'KODE-BARANG'); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loan->item?->category): ?>
                                <span class="item-code-tag" style="background: rgba(37,99,235,0.1); color:#2563eb;"><?php echo e($loan->item->category->name); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="item-meta-grid">
                            ...
                            <div class="item-meta-item" style="<?php echo e($isOverdue ? 'color:#dc2626;font-weight:700;' : ''); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width:13px;height:13px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            ...
                            <div class="item-meta-item">
                                ...
                                Guru Pembimbing: <?php echo e($loan->teacher?->name ?? '-'); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPendingVerification): ?>
                            <div style="margin-top: 10px; display: inline-flex; align-items: center; gap: 6px;">
                                ...
                                <span style="font-size: 11px; color: var(--muted);">Diajukan pada <?php echo e($latestReturn->created_at->format('d M Y H:i')); ?></span>
                            </div>
                        <?php elseif($isRejected): ?>
                            <div style="margin-top: 10px;">
                                <span class="badge-status badge-danger">Pengajuan Sebelumnya Ditolak</span>
                                <span style="font-size: 12px; color: #dc2626; margin-left: 6px;">Alasan: <?php echo e($latestReturn->alasan_ditolak); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('student.returns.create', $loan->id)); ?>" class="btn-return-cta">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width:15px;height:15px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('student.catalog')); ?>" style="display:inline-block; margin-top:14px; color:#1d4ed8; font-size:13px; font-weight:700; text-decoration:none;">
