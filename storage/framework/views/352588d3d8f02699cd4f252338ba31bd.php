<div class="im-root" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'inventory-manager'; ?>wire:key="inventory-manager">
<style>
    /* ══════════════════════════════════════════════════════════════
    ...
    <div class="im-alert im-fade">
        ...
        <span style="flex:1"><?php echo e(session('message')); ?></span>
    ...
    <div class="im-kpi-grid">
        ...
        <div class="im-kpi-card">
            ...
            <div class="im-kpi-num"><?php echo e($stats['total'] ?? 0); ?></div>
            <div class="im-kpi-sub"><?php echo e($stats['total_stock'] ?? 0); ?> unit fisik terdaftar</div>
        </div>
        ...
        <div class="im-kpi-card">
            ...
            <div class="im-kpi-num"><?php echo e($stats['tersedia'] ?? 0); ?></div>
        ...
        <div class="im-kpi-card">
            ...
            <div class="im-kpi-num"><?php echo e($stats['dipinjam'] ?? 0); ?></div>
        ...
        <div class="im-kpi-card">
            ...
            <div class="im-kpi-num"><?php echo e($stats['maintenance'] ?? 0); ?></div>
            <div class="im-kpi-sub"><span style="color:#10b981;font-weight:700"><?php echo e($stats['baik'] ?? 0); ?></span> kondisi baik</div>
        </div>
    </div>
    ...
    <div class="im-toolbar">
        ...
        <div class="im-dropdown" id="imDropCat" data-wire="filterCategory">
            ...
            <div class="im-dropdown-menu">
                ...
                <div class="im-dropdown-item" data-value="<?php echo e($cat->id); ?>" onclick="imSelectItem('imDropCat', '<?php echo e($cat->id); ?>', '<?php echo e($cat->name); ?>', this)">
                    <svg class="im-check" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
                    <?php echo e($cat->name); ?>
        ...
        <div class="im-view-toggle">
            <button type="button" wire:click="setViewMode('grid')" class="im-view-btn <?php echo e($viewMode === 'grid' ? 'active' : ''); ?>" title="Tampilan Grid">
                <svg xmlns="http://www.w3.org/2000/svg" style="width:15px;height:15px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
            </button>
            <button type="button" wire:click="setViewMode('table')" class="im-view-btn <?php echo e($viewMode === 'table' ? 'active' : ''); ?>" title="Tampilan Tabel">
        ...
        <button type="button" wire:click="toggleForm" class="im-add-btn">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:14px;height:14px;transition:transform .2s;<?php echo e($showForm ? 'transform:rotate(45deg)' : ''); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"/></svg>
            <span><?php echo e($showForm ? 'Tutup Form' : 'Tambah Barang'); ?></span>
        </button>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showForm || $editingId): ?>
    <div class="im-form-panel im-fade">
        <div class="im-form-header">
            <div>
                <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
                    <h2 class="im-form-title"><?php echo e($editingId ? 'Edit Data Barang' : 'Tambah Barang Baru'); ?></h2>
                    ...
                    <span style="display:inline-flex;align-items:center;gap:6px;background:rgba(245,158,11,.1);border:1px solid rgba(245,158,11,.25);color:#fbbf24;border-radius:999px;padding:3px 10px;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.05em">
                        ...
                        Mode Edit #<?php echo e($editingId); ?>

                    </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <p class="im-form-sub"><?php echo e($editingId ? 'Perbarui spesifikasi, lokasi, dan stok barang ini.' : 'Isi rincian barang untuk mencatatnya ke dalam sistem inventaris.'); ?></p>
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="im-field-error"><?php echo e($message); ?></span> <?php unset($message);
            ...
            <div>
                ...
                <div class="im-field-grid-4">
                    ...
                    <div>
                        ...
                        <input wire:model="purchase_year" type="number" min="2000" max="<?php echo e(date('Y')); ?>" class="im-input" placeholder="<?php echo e(date('Y')); ?>">
                    </div>
                    <div>
                ...
                <div class="im-field-grid-2-3">
                    <div>
                        ...
                        <select wire:model="location_id" class="im-select-field">
                            ...
                            <option value="<?php echo e($loc->id); ?>"><?php echo e($loc->building); ?><?php echo e($loc->floor ? ' Lt.'.$loc->floor : ''); ?> — <?php echo e($loc->room); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    <div>
                    ...
                    <div class="im-span-2">
                        ...
                        <div style="display:flex;align-items:center;gap:10px">
                            ...
                            <img src="<?php echo e($photo->temporaryUrl()); ?>" style="width:40px;height:40px;border-radius:10px;object-fit:cover;border:1px solid rgba(59,130,246,.3);flex-shrink:0">
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="im-form-actions">
                ...
                <button type="submit" class="im-btn-save">
                    ...
                    <span><?php echo e($editingId ? 'Simpan Perubahan' : 'Simpan Barang Baru'); ?></span>
                </button>
            </div>
        </form>
    </div>
    ...
    <div>
        ...
        <div class="im-list-header">
            <div style="display:flex;align-items:center">
                ...
                <span class="im-count-badge"><?php echo e($items->count()); ?> Item</span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterCategory || $filterStatus || $filterCondition): ?>
        ...
        <div class="im-card-grid">
            ...
            ?>
            <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'card-'.e($item->id).''; ?>wire:key="card-<?php echo e($item->id); ?>" class="im-card">
                ...
                <div class="im-card-img">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="im-card-code"><?php echo e($item->inventory_number); ?></div>
                    <span class="im-card-status-badge <?php echo e($statusClass); ?>">
                ...
                <div class="im-card-body">
                    ...
                    <div class="im-card-name"><?php echo e($item->name); ?></div>
                    <div class="im-card-meta"><?php echo e(implode(' · ', array_filter([$item->brand, $item->type, $item->purchase_year ? 'Th '.$item->purchase_year : null])) ?: 'Tanpa spesifikasi merk'); ?></div>
                    ...
                    <div class="im-card-info-row">
                        <div class="im-card-info-cell">
                            ...
                            <div class="im-cell-val" style="display:flex;align-items:center;gap:4px">
                                ...
                                <?php echo e($item->location?->room ?? $item->location?->building ?? '—'); ?>

                            </div>
                        </div>
                        <div class="im-card-info-cell">
                            <div class="im-cell-label">Kondisi</div>
                            <div class="im-cell-val" style="color:<?php echo e($condColor); ?>"><?php echo e($item->condition); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="im-card-footer">
                    <div>
                        <div class="im-stock-num"><?php echo e($item->stock); ?></div>
                        <div class="im-stock-sub">Unit Tersedia</div>
                    </div>
                    <div class="im-card-actions">
                        <button type="button" wire:click="edit(<?php echo e($item->id); ?>)" class="im-btn-edit">
                        ...
                        <button type="button" wire:click="delete(<?php echo e($item->id); ?>)" wire:confirm="Hapus barang '<?php echo e($item->name); ?>'?" class="im-btn-del">
            ...
            <div style="overflow-x:auto">
                <table class="im-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'row-'.e($item->id).''; ?>wire:key="row-<?php echo e($item->id); ?>">
                            <td class="center" style="color:#475569;font-family:monospace"><?php echo e($i + 1); ?></td>
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    ...
                                    <div>
                                        <div style="font-weight:700;color:#f1f5f9;font-size:13px"><?php echo e($item->name); ?></div>
                                        <div style="font-size:10px;font-family:monospace;color:#475569"><?php echo e($item->inventory_number); ?><?php echo e($item->brand ? ' · '.$item->brand : ''); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div style="font-weight:600;color:#e2e8f0;font-size:12px"><?php echo e($item->location?->room ?? $item->location?->building ?? '—'); ?></div>
                                <div style="font-size:10px;color:#475569"><?php echo e($item->supplier?->name ?? ''); ?></div>
                            </td>
                            <td><span style="font-weight:700;color:<?php echo e($condColor); ?>"><?php echo e($item->condition); ?></span></td>
                            <td>
                                <span class="im-card-status-badge <?php echo e($statusClass); ?>" style="position:static;font-size:10px">
                                    <span style="width:5px;height:5px;border-radius:50%;background:currentColor"></span>
                                    <?php echo e($item->status); ?>

                                </span>
                            </td>
                            <td class="center" style="font-weight:900;color:#60a5fa;font-size:15px"><?php echo e($item->stock); ?></td>
                            <td class="right">
                                <div class="im-table-actions">
                                    <button type="button" wire:click="edit(<?php echo e($item->id); ?>)" class="im-tbl-btn im-tbl-btn-edit" title="Edit Barang">
                                    ...
                                    <button type="button" wire:click="delete(<?php echo e($item->id); ?>)" wire:confirm="Hapus barang '<?php echo e($item->name); ?>'?" class="im-tbl-btn im-tbl-btn-del" title="Hapus Barang">
                                        <svg style="width:13px;height:13px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                    </button>
                                </div>
                            </td>
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views/livewire/inventory-manager.blade.php ENDPATH**/ ?>