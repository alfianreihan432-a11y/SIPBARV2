    ...
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <div class="qr-section">
                ...
                <img
                    src="data:image/png;base64,<?php echo e($qrBase64); ?>"
            ...
            <div class="instructions">
                ...
                <ol>
                    ...
                    <li>Datang ke tempat penyimpanan barang pada tanggal <strong><?php echo e($borrowingRequest->borrow_date?->format('d M Y') ?? '-'); ?></strong>.</li>
                    <li>Tunjukkan QR Code ini kepada petugas untuk verifikasi.</li>
                    <li>Kembalikan barang paling lambat <strong><?php echo e($borrowingRequest->return_date?->format('d M Y') ?? '-'); ?></strong>.</li>
                </ol>
            </div>
        </div>
...
<?php /**PATH C:\Users\Dell\SIPBARV2\resources\views/emails/approved.blade.php ENDPATH**/ ?>