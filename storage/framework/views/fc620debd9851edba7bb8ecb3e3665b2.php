<?php # [BlazeFolded]:{flux::icon.chevron-down}:{C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-down.blade.php}:{1781785518} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1781785518} ?>
...
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1781785518} ?>
<?php
if (!function_exists('_fc620debd9851edba7bb8ecb3e3665b2')):
function _fc620debd9851edba7bb8ecb3e3665b2($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _afb80f9a481bc6f154b41a9a23b85b61($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _afb80f9a481bc6f154b41a9a23b85b61($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
                ...
                <div class="hidden in-data-flux-menu:block">
                    <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php', $__blaze->compiledPath.'/f4fb05dacd2d28cdf3957eb38c197823.php'); ?>
...
<?php _f4fb05dacd2d28cdf3957eb38c197823($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/eb0280ea048d944ac8ad035ff9f51ae6.php'); ?>
...
<?php _eb0280ea048d944ac8ad035ff9f51ae6($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
>
    <?php ob_start(); ?>
                <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/b76096bc4d1329f76df10264af2e70af.php'); ?>
<?php if (isset($__slotsb76096bc4d1329f76df10264af2e70af)) { $__slotsStackb76096bc4d1329f76df10264af2e70af[] = $__slotsb76096bc4d1329f76df10264af2e70af; } ?>
<?php if (isset($__attrsb76096bc4d1329f76df10264af2e70af)) { $__attrsStackb76096bc4d1329f76df10264af2e70af[] = $__attrsb76096bc4d1329f76df10264af2e70af; } ?>
<?php $__attrsb76096bc4d1329f76df10264af2e70af = ['heading' => $heading]; ?>
<?php $__slotsb76096bc4d1329f76df10264af2e70af = []; ?>
<?php $__blaze->pushData($__attrsb76096bc4d1329f76df10264af2e70af); ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $__slotsb76096bc4d1329f76df10264af2e70af['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsb76096bc4d1329f76df10264af2e70af); ?>
<?php _b76096bc4d1329f76df10264af2e70af($__blaze, $__attrsb76096bc4d1329f76df10264af2e70af, $__slotsb76096bc4d1329f76df10264af2e70af, ['heading'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackb76096bc4d1329f76df10264af2e70af)) { $__slotsb76096bc4d1329f76df10264af2e70af = array_pop($__slotsStackb76096bc4d1329f76df10264af2e70af); } ?>
<?php if (! empty($__attrsStackb76096bc4d1329f76df10264af2e70af)) { $__attrsb76096bc4d1329f76df10264af2e70af = array_pop($__attrsStackb76096bc4d1329f76df10264af2e70af); } ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\stubs\resources\views\flux\sidebar\group.blade.php ENDPATH**/ ?>