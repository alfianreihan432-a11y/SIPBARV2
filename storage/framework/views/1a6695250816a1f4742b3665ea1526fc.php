...
<div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'user-manager'; ?>wire:key="user-manager" wire:poll.5000ms="loadSyncStatus">
<style>
                ...
                <div class="um-field">
                    ...
                    <div class="um-input-wrap">
                        ...
                        <select wire:model="classroom_id" class="um-input" style="cursor:pointer">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<div class="um-table-card">
    <div class="um-table-header">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syncStatus): ?>
                <div style="display:flex;align-items:center;gap:8px;padding:6px 12px;border-radius:8px;font-size:12px;font-weight:600;<?php echo e($syncStatus === 'running' ? 'background:rgba(59,130,246,.1);color:var(--blue);border:1px solid rgba(59,130,246,.2)' : ($syncStatus === 'completed' ? 'background:rgba(16,185,129,.1);color:#10b981;border:1px solid rgba(16,185,129,.2)' : 'background:rgba(239,68,68,.1);color:#ef4444;border:1px solid rgba(239,68,68,.2)')); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syncStatus === 'running'): ?>
                    ...
                    <?php elseif($syncStatus === 'completed'): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span><?php echo e($syncMessage); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syncStatus === 'running'): ?>
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <button type="button" wire:click="syncFromSipintu" wire:loading.attr="disabled" <?php echo e($isSyncRunning ? 'disabled' : ''); ?> class="um-btn" style="padding:7px 14px;font-size:12px;background:linear-gradient(135deg,#1d4ed8,#2563eb);color:#fff;border:none;box-shadow:0 3px 10px rgba(29,78,216,.3);<?php echo e($isSyncRunning ? 'opacity:0.6;cursor:not-allowed' : ''); ?>">
                ...
                <span wire:loading.remove><?php echo e($isSyncRunning ? 'Sinkronisasi Berjalan...' : 'Sinkronkan dari SiPintu'); ?></span>
            </button>
            ...
            <tbody>
                ...
                <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'u-'.e($u->id).''; ?>wire:key="u-<?php echo e($u->id); ?>">
                    ...
                    <td style="font-size:13px;color:#475569">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uRole === 'siswa'): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($u->classroom): ?>
                                <span style="display:inline-flex;align-items:center;gap:4px;padding:3px 8px;background:<?php echo e($u->classroom->getBackgroundColor()); ?>;border:1px solid <?php echo e($u->classroom->getBorderColor()); ?>;border-radius:6px;font-size:11px;font-weight:600;color:<?php echo e($u->classroom->getTextColor()); ?>">
                                    <?php echo e($u->classroom->name); ?>
...
<?php /**PATH C:\Users\Dell\SIPBARV2\resources\views/livewire/user-manager.blade.php ENDPATH**/ ?>