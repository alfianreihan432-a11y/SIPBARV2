<?php # [BlazeFolded]:{flux::callout.heading}:{C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/callout/heading.blade.php}:{1781785518} ?>
<?php # [BlazeFolded]:{flux::callout.text}:{C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/callout/text.blade.php}:{1781785518} ?>
<?php
if (!function_exists('_7ff206d3aba1bfd464ca64b288be1b55')):
function _7ff206d3aba1bfd464ca64b288be1b55($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _afb80f9a481bc6f154b41a9a23b85b61($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\stubs\resources\views\flux\callout\index.blade.php ENDPATH**/ ?>