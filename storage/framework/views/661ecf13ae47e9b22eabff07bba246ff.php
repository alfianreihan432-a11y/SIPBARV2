<?php $__env->startSection('title', 'Peminjaman Saya – SIPBAR'); ?>
...
<div class="page-header">
    <div class="page-header-left">
        <div class="page-title">
            ...
            <span class="page-title-count"><?php echo e($requests->count()); ?> transaksi</span>
...
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:22px" class="loans-stat-grid">
    <div class="s-stat" style="padding:14px 16px">
        ...
        <div class="s-stat-body">
            <div class="s-stat-num" style="font-size:20px"><?php echo e($counts['pending']); ?></div>
    ...
    <div class="s-stat" style="padding:14px 16px">
        ...
        <div class="s-stat-body">
            <div class="s-stat-num" style="font-size:20px"><?php echo e($counts['borrowed']); ?></div>
    ...
    <div class="s-stat" style="padding:14px 16px">
        ...
        <div class="s-stat-body">
            <div class="s-stat-num" style="font-size:20px"><?php echo e($counts['returned']); ?></div>
    ...
    <div class="s-stat" style="padding:14px 16px">
        ...
        <div class="s-stat-body">
            <div class="s-stat-num" style="font-size:20px"><?php echo e($counts['rejected']); ?></div>
...
<div class="s-card">
    <div class="s-card-header">
        ...
        <a href="<?php echo e(route('student.history')); ?>" class="s-card-action">Riwayat Lengkap →</a>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requests->count() > 0): ?>
        ...
        <?php $st = $statusMap[$req->status] ?? $statusMap['pending']; ?>
        <div class="s-loan-row <?php echo e($st['row']); ?>">
            ...
            <div class="s-loan-content">
                <div class="s-loan-name"><?php echo e($req->item?->name ?? 'Barang tidak tersedia'); ?></div>
                <div class="s-loan-code">ID: #<?php echo e($req->id); ?> · Qty: <?php echo e($req->quantity); ?> unit</div>
                <div class="s-loan-meta">
                    <div class="s-loan-meta-item">
                        ...
                        <?php echo e($req->borrow_date->format('d M Y')); ?> – <?php echo e($req->return_date->format('d M Y')); ?>

                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->purpose): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->status === 'pending'): ?>
                    ...
                    <div style="margin-top:10px;display:flex;gap:8px;flex-wrap:wrap">
                        <a href="<?php echo e(route('student.loans.edit', $req->id)); ?>" class="s-btn s-btn--sm s-btn--ghost">
                            Edit
                        </a>
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <form method="POST" action="<?php echo e(route('student.loans.cancel', $req->id)); ?>" onsubmit="return confirm('Yakin ingin membatalkan peminjaman ini?')" style="display:inline;">
                            <?php echo csrf_field(); ?>
                ...
                <div style="margin-top:8px;padding:8px 12px;background:var(--s-rejected-bg);border:1px solid var(--s-rejected-bdr);border-radius:8px;font-size:12px;color:var(--s-rejected)">
                    <strong>Alasan ditolak:</strong> <?php echo e($req->rejection_reason); ?>
            ...
            <div class="s-loan-right">
                ...
                <span class="s-loan-time"><?php echo e($req->created_at->diffForHumans()); ?></span>
            </div>
        </div>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views/pages/siswa/loans.blade.php ENDPATH**/ ?>