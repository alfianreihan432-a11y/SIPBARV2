<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('inventory.index')); ?>" class="nav-item <?php echo e(request()->routeIs('inventory.index') ? 'active' : ''); ?>">
            ...
            Barang
            <span class="nav-badge"><?php echo e(\App\Models\Item::count()); ?></span>
        </a>
        ...
        <a href="<?php echo e(route('returns.index')); ?>" class="nav-item <?php echo e(request()->routeIs('returns.index') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\components\admin-sidebar.blade.php ENDPATH**/ ?>