...
<?php $__env->startSection('page-heading', 'Profil Siswa'); ?>
...
<div>
    ...
    <div class="profile-header">
        <div class="profile-header-content">
            <div class="profile-avatar">
                <?php echo e(auth()->check() ? strtoupper(substr(auth()->user()->name,0,2)) : 'SI'); ?>

            </div>
            <div class="profile-info">
                <h1><?php echo e(auth()->check() ? auth()->user()->name : 'Siswa'); ?></h1>
    ...
    <div class="profile-section">
        ...
        <div class="stat-grid">
            ...
            <div class="stat-card">
                <div class="stat-value">
                    <?php echo e(\App\Models\BorrowingRequest::where('user_id', auth()->id())->where('status', 'borrowed')->count()); ?>
    ...
    <div class="profile-section">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap">
            <a href="<?php echo e(route('student.catalog')); ?>" class="btn">Lihat Katalog Barang</a>
            <a href="<?php echo e(route('student.history')); ?>" class="btn btn-outline">Lihat Riwayat Peminjaman</a>
            <a href="<?php echo e(route('student.announcements')); ?>" class="btn btn-outline">Lihat Pengumuman</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\pages\siswa\profile.blade.php ENDPATH**/ ?>