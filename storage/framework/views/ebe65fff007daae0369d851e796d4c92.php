<?php $__env->startSection('title', 'Pengaturan - Tampilan'); ?>
...
<div style="display:flex;flex-direction:column;gap:20px">
    ...
    <?php echo $__env->make('partials.settings-tabs', ['active' => 'appearance'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div style="padding:18px 28px">
        ...
        <div style="margin-top:12px;display:flex;gap:16px;flex-wrap:wrap">
            <div>
                ...
                <code style="font-size:12px;color:var(--text-muted);background:var(--bg-card-subtle);border:1px solid var(--border-subtle);border-radius:6px;padding:3px 8px"><?php echo e(config('sipintu.api_url')); ?></code>
            </div>
            <div>
                ...
                <code style="font-size:12px;color:var(--text-muted);background:var(--bg-card-subtle);border:1px solid var(--border-subtle);border-radius:6px;padding:3px 8px"><?php echo e(config('sipintu.client_id') ?: '(belum dikonfigurasi)'); ?></code>
            </div>
        </div>
    </div>
</div>
...
async function cekKoneksiSipintu() {
    ...
    try {
        const res  = await fetch('<?php echo e(route("sipintu.status")); ?>', {
        ...
        if (data.connected) {
            ...
            infoBox.innerHTML = `<div style="display:flex;align-items:center;gap:8px;color:#ef4444;font-size:13px;font-weight:600">
                ...
                ${data.error ?? 'Tidak dapat terhubung ke SiPintu. Pastikan server SiPintu berjalan di ' + '<?php echo e(config("sipintu.api_url")); ?>.'}
            </div>`;
        }
    } catch (err) {
        badge.style.background = 'rgba(239,68,68,.1)';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\SIPBARV2\resources\views\pages\admin\settings-appearance.blade.php ENDPATH**/ ?>