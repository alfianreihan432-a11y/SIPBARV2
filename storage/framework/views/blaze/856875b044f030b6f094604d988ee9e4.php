<?php
if (!function_exists('__856875b044f030b6f094604d988ee9e4')):
function __856875b044f030b6f094604d988ee9e4($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($slot); ?><?php $__slotsbc7e314f6de596e6a79abc61d634bf39['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
...
<?php ('__' . $__resolved)($__blaze, $__delegatedData, $__slotsbc7e314f6de596e6a79abc61d634bf39, [], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/group/index.blade.php ENDPATH**/ ?>