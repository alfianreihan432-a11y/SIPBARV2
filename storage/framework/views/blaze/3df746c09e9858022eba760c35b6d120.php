<?php
if (!function_exists('__3df746c09e9858022eba760c35b6d120')):
function __3df746c09e9858022eba760c35b6d120($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($collapsibleOnMobile): ?>
    <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/33b62817152968c96a5de4c716292cca.php'); ?>
<?php $__blaze->pushData([]); ?>
<?php __33b62817152968c96a5de4c716292cca($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php endif; ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>