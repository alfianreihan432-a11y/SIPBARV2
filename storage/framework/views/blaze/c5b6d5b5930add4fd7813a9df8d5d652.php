<?php
if (!function_exists('__c5b6d5b5930add4fd7813a9df8d5d652')):
function __c5b6d5b5930add4fd7813a9df8d5d652($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
