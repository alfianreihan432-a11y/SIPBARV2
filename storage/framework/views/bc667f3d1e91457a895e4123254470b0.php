<?php
if (!function_exists('_bc667f3d1e91457a895e4123254470b0')):
function _bc667f3d1e91457a895e4123254470b0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<th <?php echo e($attributes->class($classes)); ?> data-flux-column>
    <?php if ($sortable): ?>
        <div class="flex in-[.group\/center-align]:justify-center in-[.group\/end-align]:justify-end">
            <?php $__blaze->ensureRequired('C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\src/../stubs/resources/views/flux/table/sortable.blade.php', $__blaze->compiledPath.'/8dd8f9168074702485a29e96002d471c.php'); ?>
<?php if (isset($__slots8dd8f9168074702485a29e96002d471c)) { $__slotsStack8dd8f9168074702485a29e96002d471c[] = $__slots8dd8f9168074702485a29e96002d471c; } ?>
<?php if (isset($__attrs8dd8f9168074702485a29e96002d471c)) { $__attrsStack8dd8f9168074702485a29e96002d471c[] = $__attrs8dd8f9168074702485a29e96002d471c; } ?>
<?php $__attrs8dd8f9168074702485a29e96002d471c = ['sorted' => $sorted,'direction' => $direction]; ?>
<?php $__slots8dd8f9168074702485a29e96002d471c = []; ?>
<?php $__blaze->pushData($__attrs8dd8f9168074702485a29e96002d471c); ?>
<?php ob_start(); ?>
                <div><?php echo e($slot); ?></div>
            <?php $__slots8dd8f9168074702485a29e96002d471c['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots8dd8f9168074702485a29e96002d471c); ?>
<?php _8dd8f9168074702485a29e96002d471c($__blaze, $__attrs8dd8f9168074702485a29e96002d471c, $__slots8dd8f9168074702485a29e96002d471c, ['sorted', 'direction'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack8dd8f9168074702485a29e96002d471c)) { $__slots8dd8f9168074702485a29e96002d471c = array_pop($__slotsStack8dd8f9168074702485a29e96002d471c); } ?>
<?php if (! empty($__attrsStack8dd8f9168074702485a29e96002d471c)) { $__attrs8dd8f9168074702485a29e96002d471c = array_pop($__attrsStack8dd8f9168074702485a29e96002d471c); } ?>
<?php $__blaze->popData(); ?>
        </div>
    <?php else: ?>
...
} endif; ?><?php /**PATH C:\Users\ASUS\SIPBARV2\vendor\livewire\flux\stubs\resources\views\flux\table\column.blade.php ENDPATH**/ ?>