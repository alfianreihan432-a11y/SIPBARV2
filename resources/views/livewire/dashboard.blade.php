<div>
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            ...
            <div class="hero-greeting">
                ...
                @endphp
                {{ $greet }}, {{ auth()->check() ? auth()->user()->name : 'Admin' }}
            </div>
    ...
    <div class="db-stat-grid">
        <div class="db-stat-card">
            ...
            <div>
                <div class="db-stat-num">{{ $totalItems }}</div>
        ...
        <div class="db-stat-card">
            ...
            <div>
                <div class="db-stat-num">{{ $borrowedItems }}</div>
            ...
            <div class="db-status-grid">
                <div class="db-status-bar-item">
                    <div class="db-bar-wrap">
                        <div class="db-bar" style="height:{{ $totalItems > 0 ? ($availableItems / $totalItems * 70) : 0 }}px;background:#10b981"></div>
                    </div>
                    <div class="db-bar-val">{{ $availableItems }}</div>
                    <div class="db-bar-label">Tersedia</div>
                </div>
                <div class="db-status-bar-item">
                    <div class="db-bar-wrap">
                        <div class="db-bar" style="height:{{ $totalItems > 0 ? ($borrowedItems / $totalItems * 70) : 0 }}px;background:#ef4444"></div>
                    </div>
                    <div class="db-bar-val">{{ $borrowedItems }}</div>
                    <div class="db-bar-label">Dipinjam</div>
                </div>
                <div class="db-status-bar-item">
                    <div class="db-bar-wrap">
                        <div class="db-bar" style="height:{{ $totalItems > 0 ? (($totalItems - $availableItems - $borrowedItems) / $totalItems * 70) : 0 }}px;background:#f59e0b"></div>
                    </div>
                    <div class="db-bar-val">{{ $totalItems - $availableItems - $borrowedItems }}</div>
