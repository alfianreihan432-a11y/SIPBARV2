    ...
    <div class="ta-page-header">
        ...
        @if(!$pendingRequests->isEmpty())
            <div class="ta-count-badge">
                <span class="ta-count-num">{{ $pendingRequests->count() }}</span>
            ...
            @foreach($pendingRequests as $request)
                <div class="ta-card">
                    ...
                    <div class="ta-card-header">
                        <div class="ta-student-info">
                            ...
                            <div class="ta-student-meta">
                                <h3 class="ta-student-name">{{ $request->user->name ?? 'N/A' }}</h3>
                                <p class="ta-student-class">
                                    ...
                                    {{ $request->user->kelas ?? 'N/A' }} &bull; {{ $request->user->jurusan ?? 'N/A' }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="ta-card-body">
                        ...
                        <div class="ta-detail-grid">
                            ...
                            <div class="ta-detail-item">
                                ...
                                <span class="ta-field-value">{{ \Carbon\Carbon::parse($request->borrow_date)->format('d M Y') }}</span>
                            </div>
                            <div class="ta-detail-item">
                                <span class="ta-field-label">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width:11px;height:11px">
                            ...
                            <div class="ta-detail-item">
                                ...
                                <span class="ta-field-value">{{ $request->purpose ?? '-' }}</span>
                            </div>
                        </div>
                    ...
                    <div class="ta-card-footer">
                        <form action="{{ route('teacher.requests.approve', $request->id) }}" method="POST" class="ta-btn-wrap">
                            @csrf
                        ...
                        <button wire:click="openRejectModal({{ $request->id }})" class="ta-btn ta-btn-reject">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="width:16px;height:16px">
