...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { display: flex; background: #f0f4ff; color: #1e293b; overflow: hidden; }
        ...
        .topbar-icon {
            ...
            display: flex; align-items: center; justify-content: center;
            cursor: pointer; color: #64748b; transition: all .15s; position: relative;
        }
        .topbar-icon:hover { background: #e2e8f0; color: #334155; }
        .notif-dot {
        ...
        .topbar-uname { font-size: 13px; font-weight: 600; color: #334155; }
    </style>
</head>
<body>
    <style>
        /* ===== CONTENT LAYOUT ===== */
        .content { flex: 1; overflow-y: auto; padding: 22px 24px; background: #f0f4ff; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        @php
        $navItems = [
            ['Dashboard',    'active', 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', null],
            ['Katalog Barang','',      'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4',     null],
            ['Peminjaman',   '',       'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4',                      '3'],
            ['Riwayat',      '',       'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',                             null],
            ['Pengumuman',   '',       'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9', '2'],
            ['Profil',       '',       'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',   null],
        ];
        @endphp
        @foreach($navItems as $nav)
        <a href="#" class="nav-item {{ $nav[1] }}">
