@props(['iconClass' => 'topbar-icon'])

{{-- Widget Pesan (Amplop) --}}
<div class="notif-widget-wrapper" style="position:relative;display:inline-block;">
    <button type="button" class="{{ $iconClass }}" id="messageIconBtn" title="Pesan" aria-label="Buka Pesan" style="position:relative;cursor:pointer;">
...
{{-- Widget Notifikasi (Lonceng) --}}
<div class="notif-widget-wrapper" style="position:relative;display:inline-block;">
    <button type="button" class="{{ $iconClass }}" id="notifIconBtn" title="Notifikasi" aria-label="Buka Notifikasi" style="position:relative;cursor:pointer;">
        <svg xmlns="http://www.w3.org/2000/svg" style="width:16px;height:16px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
