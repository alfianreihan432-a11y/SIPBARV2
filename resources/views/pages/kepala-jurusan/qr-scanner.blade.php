...
<div class="qr-scanner-card">
    <div style="text-align: center; margin-bottom: 20px;">
        <div style="width: 48px; height: 48px; border-radius: 12px; background: var(--accent-light); color: var(--accent); display: flex; align-items: center; justify-content: center; margin: 0 auto 12px;">
    ...
    <div class="qr-viewport-wrap">
        ...
        <div id="camera-placeholder" class="qr-placeholder">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:46px;height:46px;color:var(--accent-text);margin-bottom:12px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/>
            </svg>
            <div style="font-size:14.5px;font-weight:700;color:var(--text);margin-bottom:5px;">Kamera Siap Digunakan</div>
            <div style="font-size:12.5px;color:var(--muted);margin-bottom:16px;max-width:280px;line-height:1.4;">Nyalakan kamera untuk scan langsung, atau upload foto/gambar QR Code dari perangkat.</div>
    ...
    <div id="camera-controls" style="display:none;justify-content:center;gap:10px;margin-bottom:16px;flex-wrap:wrap;">
        <button type="button" onclick="stopCamera()" class="qr-btn qr-btn-secondary" style="font-size:12.5px;padding:8px 14px;">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:14px;height:14px;color:var(--accent)" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function handleDecodedToken(decodedText) {
    ...
    if (token) {
        setTimeout(function() {
            window.location.href = "{{ url('/kajur/qr/verify') }}/" + encodeURIComponent(token);
        }, 350);
    } else {
...
/**
 * Multi-pass QR Decoder for uploaded image files.
 * Tries jsQR across original and downscaled resolutions, then falls back to html5-qrcode.
 */
...
function handleManualSubmit(event) {
    ...
    if (token) {
        ...
        alert('Mohon masukkan token atau URL QR yang valid.');
    }
}
</script>
@endsection