...
<div style="display:flex;flex-direction:column;gap:22px">
                ...
                <div style="display:flex;flex-direction:column;gap:7px">
                    ...
                    <div style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--text-muted)">
                        <div style="width:20px;height:20px;background:rgba(29,78,216,.2);border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--blue)">
                            <svg xmlns="http://www.w3.org/2000/svg" style="width:12px;height:12px" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="16" cy="16" r="1"/><circle cx="8" cy="16" r="1"/><path d="M12.82 13.58a3 3 0 0 0-4.06-4.06"/><path d="M2.58 11.58a6 6 0 0 1 10.83-3.16"/><path d="M7.73 15.27 6 17"/><path d="m14 12 1.59 1.59"/><path d="M21 21a2 2 0 0 0 2-2v-3h-3"/><path d="M16 7.5V6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v1.5"/></svg>
                        </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px">
        @foreach([
            ...
            ['<svg xmlns="http://www.w3.org/2000/svg" style="width:22px;height:22px;color:#f97316" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>','Ekstra','Kelola ekstrakurikuler & akun pendamping','#f97316','rgba(249,115,22,.1)'],
        ] as $r)
