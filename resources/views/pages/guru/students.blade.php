...
<div>
    ...
    <div class="search-box">
        <form method="GET" action="{{ route('teacher.students') }}" class="search-form">
            ...
            <div class="student-card">
                ...
                <div class="student-stats">
                    <div class="stats-grid">
                        <div class="mini-stat">
                            <p class="mini-stat-value">{{ $pending }}</p>
                            <p class="mini-stat-label">Pending</p>
                        </div>
                        <div class="mini-stat">
                            <p class="mini-stat-value">{{ $active }}</p>
                            <p class="mini-stat-label">Aktif</p>
                        </div>
                        <div class="mini-stat">
                            <p class="mini-stat-value">{{ $completed }}</p>
                ...
                <div class="student-actions">
                    <a href="{{ route('teacher.requests') }}?student={{ $student->id }}" class="btn btn-full">
                        Lihat Pengajuan
                    </a>
                </div>
            </div>
    ...
    <div class="empty-state">
        ...
        @if(request('search'))
            <a href="{{ route('teacher.students') }}" class="btn">
                Lihat Semua Siswa
            </a>
        @endif
    </div>
