...
@section('title', 'Form Pengajuan Pengembalian – SIPBAR')
@section('page-heading', 'Ajukan Pengembalian')
...
<div class="form-container">
    ...
    <div style="margin-bottom: 16px;">
        <a href="{{ route('student.returns.index') }}" style="color: var(--muted); text-decoration: none; font-size: 12px; font-weight: 700; display: inline-flex; align-items: center; gap: 4px;">
    ...
    <div class="form-panel">
        ...
        <div class="item-summary-card">
            <div>
                ...
                <div style="font-size: 12px; color: var(--muted); margin-top: 2px;">
                    Kode: <strong>{{ $borrowing->item?->code ?? '-' }}</strong> &bull; Qty: <strong>{{ $borrowing->quantity }} Unit</strong>
                </div>
            </div>
        ...
        <form action="{{ route('student.returns.store') }}" method="POST" enctype="multipart/form-data" id="returnForm">
            ...
            <div class="form-group">
                ...
                <div class="condition-grid">
                    <label class="condition-option">
                        <input type="radio" name="kondisi_barang" value="baik" {{ old('kondisi_barang', 'baik') === 'baik' ? 'checked' : '' }}>
                    ...
                    <label class="condition-option">
                        <input type="radio" name="kondisi_barang" value="rusak_ringan" {{ old('kondisi_barang') === 'rusak_ringan' ? 'checked' : '' }}>
                        <div class="condition-card">
                    ...
                    <label class="condition-option">
                        <input type="radio" name="kondisi_barang" value="rusak_berat" {{ old('kondisi_barang') === 'rusak_berat' ? 'checked' : '' }}>
                        <div class="condition-card">
                            <span style="font-size: 20px;">❌</span>
                    ...
                    <label class="condition-option">
                        <input type="radio" name="kondisi_barang" value="hilang" {{ old('kondisi_barang') === 'hilang' ? 'checked' : '' }}>
                        <div class="condition-card">
                            <span style="font-size: 20px;">🔍</span>
            ...
            {{-- 3. Upload Foto Bukti Kondisi Barang --}}
            <div class="form-group">
                <label class="form-label">
            ...
            <div class="form-actions">
                <a href="{{ route('student.returns.index') }}" class="btn-secondary">Batal</a>
