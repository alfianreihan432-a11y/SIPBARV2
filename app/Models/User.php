 ...
 */
#[Fillable(['name', 'email', 'password', 'nis', 'kelas', 'alamat', 'tanggal_lahir', 'nip', 'phone', 'jurusan', 'jabatan', 'jurusan_id', 'email_verified_at', 'role', 'data_source', 'sipintu_synced_at', 'classroom_id', 'foto_profil'])]
